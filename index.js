...
# تم إصلاح الخطأ 1: إزالة علامة التنصيص الزائدة في البداية
...
def analyze_market(market):
    ...
    # تم إصلاح الخطأ 2: تغيير اسم النموذج إلى نموذج موجود وفعال
...
# تم إصلاح الخطأ 3: التحقق من وجود أسواق قبل البدء بالدورة
if markets:
    for m in markets[:3]:
        print(f"\n📊 {m.get('question')}")
    ...
    print("⚠️ لم يتم العثور على أي أسواق.")
