...
// [1] إعدادات المحفظة والشبكة (استخدم رابط RPC مستقر)
const PRIVATE_KEY = "ضع_مفتاحك_الخاص_هنا"; // <--- ضع مفتاحك هنا بين علامتي التنصيص
...
// [3] الأسواق (تأكد أن العنوان هو عنوان العقد الصحيح الذي تستهدفه)
const MARKETS = {
